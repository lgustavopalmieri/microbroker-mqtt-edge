...
| -------------------- | ------------------- | ------------------------- |
| [Existing Component] | `path/to/file`      | [Extend/Import/Reference] |
| [Existing Utility]   | `path/to/util`      | [How it helps]            |
| [Existing Pattern]   | `path/to/pattern`   | [Apply same pattern]      |
...
Describe each model in your stack's idiom — a struct, class, interface, schema, or record. A field table keeps the model unambiguous regardless of language; translate it into real code during Execute.
...
| [field1]    | [type]    | [constraint/meaning] |
| [field2]    | [type]    | [constraint/meaning] |
